...
- 遵循 VibeCoding_Workflow_Templates/2-contracts/API-0000-api-spec.template.md
...
- **模組規格**: 2-contracts/MC-0000-module-contract.template.md (實作細節)
- **安全檢查**: 3-process/PROC-0004-security-readiness-checklist.md (安全審查)
